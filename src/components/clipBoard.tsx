    ...
    <div className="container pt-5">
      <div className="row">
        <div className="col-lg-4 col-sm-12">
          <div className="clip">
            <img className="center-block" width="60px" height="90px" src={"/img/Firebase.png"} alt="firebase" />
        ...
        <div className="col-lg-4 col-sm-12">
          <div className="clip">
            <img className="center-block" width="80px" height="90px" src={'/img/Angular.png'} alt="angular" />
            <div className="card-body text-center">
              <h4>ANGULAR 2+</h4>
              <p className="clip-text">
        ...
        <div className="col-lg-4 col-sm-12">
          <div className="clip">
            <img className="center-block" width="90px" height="90px" src={'/img/react.png'} alt="react" />
            <div className="card-body text-center">
              <h4>REACT</h4>
              <p className="clip-text">
